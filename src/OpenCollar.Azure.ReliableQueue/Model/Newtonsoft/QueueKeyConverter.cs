...
{
    /// <summary>
    ///     A converter that ensures that reliable queue keys are represented in the correct format.
    /// </summary>
    /// <seealso cref="OpenCollar.Azure.ReliableQueue.Model.QueueKey" />
    public sealed class QueueKeyConverter : JsonConverter<QueueKey?>
    {
        /// <summary>
        ///     Gets a common instance of the converter that can be reused as necessary.
        /// </summary>
        /// <value>
        ///     A common instance of the converter that can be reused as necessary.
        /// </value>
        [NotNull]
        ...
        ///     The existing value of object being read. If there is no existing value then <see langword="null" /> will
        ///     be used.
        /// </param>
            ...
            JsonSerializer serializer)
        {
            ...
            if(reader.TokenType == JsonToken.String)
            {
                ...
                {
                    throw new JsonSerializationException("Invalid token value.  Null or empty not permitted.");
                }
                return new QueueKey(value);
            }
            else
            {
