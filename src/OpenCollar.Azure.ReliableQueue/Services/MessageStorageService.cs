...
namespace OpenCollar.Azure.ReliableQueue.Services
{
    ...
    internal sealed class MessageStorageService : IMessageStorageService
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MessageStorageService"/> class.
        /// </summary>
            ...
            CancellationToken? cancellationToken = null)
        {
            ...
            var blobClient = _storageResourceService.GetBlobClient(queueKey);
            ...
            var containerReference = blobClient.GetContainerReference(Identifiers.GetMessageContainerName(queueKey));
        ...
        public async Task<Stream?> ReadMessageAsync(QueueKey queueKey, Message message, Stream blob, TimeSpan? timeout = null,
            CancellationToken? cancellationToken = null)
        {
            if (message.BodyIsNull || message.Size is null)
            {
