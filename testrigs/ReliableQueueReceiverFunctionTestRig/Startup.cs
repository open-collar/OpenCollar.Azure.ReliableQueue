...
{
    /// <summary>Defines the environment in which a function is executing.</summary>
    public sealed class Startup : FunctionsStartup
    {
        ...
        /// <summary>Configures the services that will be available in the web application.</summary>
        /// <param name="services">The collection in which to register services.</param>
